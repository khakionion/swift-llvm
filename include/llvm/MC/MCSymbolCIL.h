...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_MC_MCSYMBOLCIL_H
#define LLVM_MC_MCSYMBOLCIL_H

#include "llvm/ADT/Twine.h"
#include "llvm/MC/MCSymbol.h"

namespace llvm {
class MCSymbolCIL : public MCSymbol {
  /// \brief We store the value for the 'desc' symbol field in the
  /// lowest 16 bits of the implementation defined flags.
  enum CILSymbolFlags : uint16_t { // See <mach-o/nlist.h>.
...
public:
  MCSymbolCIL(const StringMapEntry<bool> *Name, bool isTemporary)
      : MCSymbol(SymbolKindCIL, Name, isTemporary) {}
  ...
  static bool classof(const MCSymbol *S) { return S->isCIL(); }
};
}
